...
const EKIPMAN_KONTROL_SORULARI = {
  ...
  'Alarm / Siren': [
    ...
    { id: 'uzaktanDuyuluyor', soru: 'Alarm sesi uzak noktadan duyuluyor' },
...
const HAZIR_ACIL_DURUM_SENARYOLARI = [
  ...
  { tesisTuru: 'İnşaat Sahası', kategori: 'İnsan Kaynaklı', tur: 'Diğer', baslik: 'Yüksekten Düşme (İskele/Çatı)',
    ...
    ilk1Dk: 'Kazazedeye dokunulmadan bilinç/nabız kontrol edilir; boyun/omurga sabitlenmeden kesinlikle hareket ettirilmez.', ilk5Dk: 'İlk Yardım ekibi ve ambulans çağrılır, olay yeri güvenlik şeridiyle çevrelenir, düşmeye sebep olan tehlike (varsa) izole edilir.', ilk15Dk: 'Ambulans gelene kadar kazazede izlenir, şantiye şefi/İG uzmanına bilgi verilir, tanık ifadeleri kayıt altına alınır.',
  ...
  { tesisTuru: 'İnşaat Sahası', kategori: 'İnsan Kaynaklı', tur: 'Diğer', baslik: 'Vinç / Kule Vinç Devrilmesi veya Yük Düşmesi',
    ...
    ilk1Dk: 'Vinç çalışma alanındaki tüm personel derhal uzaklaşır, operatöre ve çevredeki ekiplere anons/düdükle uyarı yapılır.', ilk5Dk: 'Alan geniş çapta çevrelenir, yaralı varsa İlk Yardım ekibi ve ambulans çağrılır.', ilk15Dk: 'Şantiye şefi/İG uzmanı olay yerine gelir, vincin/yükün stabilitesi değerlendirilmeden alana girilmez.',
