...
function _sjOrtakStilHtml(kokSelector) {
  return `
    <style>
      ...
      ${kokSelector} table.egt-konu th{ background:#dbeafe; color:#0b2c52; font-size:8.5pt; padding:2mm 3mm; text-transform:uppercase; text-align:left; border-bottom:1.5px solid #0b2c52; }
      ...
      ${kokSelector} .egt-genel-toplam td{ font-weight:800; font-size:10pt; background:#dbeafe; color:#0b2c52; border-top:1.5px solid #0b2c52; }
