...
const _KUCUK_SENKRON_ANAHTARLAR = new Set(['isg_kullanicilar', 'isg_firmalar', 'isg_risk_sablonlari', 'isg_bildirimler', 'isg_oturum_gecmisi', 'isg_eposta_config']);
...
function _firebaseAuthSdkHazirOlduğunda(callback) {
  ...
  script.onerror = () => console.error('Firebase Auth SDK yüklenemedi (ağ/CDN engeli olabilir).');
